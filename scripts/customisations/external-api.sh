...
# remove keystone/keycloak federation integration
sed -i "/keystone_logout_url: .*/d" /opt/configuration/environments/kolla/configuration.yml
rm /opt/configuration/environments/kolla/files/overlays/horizon/custom_local_settings
rm /opt/configuration/environments/kolla/files/overlays/keystone/wsgi-keystone.conf
